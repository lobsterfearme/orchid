...
# Tuya API config - tuya app project
...
async def trigger_mist(req: MistRequest):
        """
            Trigger a mist cycle on demand.
                Turns valve ON, waits duration, turns OFF.
                    """
        try:
...
async def check_mist_needed():
        """
            Check if an extra mist cycle is needed based on feels-like temperature.
                Returns recommendation + current weather data.
    ...
    # Determine watering frequency
        ...
        watering_note = f"Feels like {feels_like}°F — HIGH HEAT: adding extra mist cycle and increased orchid watering frequency."
else:
